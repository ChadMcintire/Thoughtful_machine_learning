...
class Regression(object):
    ...
    def regress(self, query_point):
        """
        Calculates predicted value for house particular parameters
...
class RegressionTest(object):
    ...
    def load_csv_file(self, csv_file, limit=None):
        ...
        house = (houses - houses.mean()) / (houses.max() - houses.min())
        self.houses = houses
    ...
    def tests(self, folds):
        ...
        for _ in range(folds):
            ...
            print("values_actual", values_actual, "values_regress", values_regress)
            print("mean abs error", mean_absolute_error(values_actual, values_regress))
